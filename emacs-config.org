...
(use-package org-tempo
  ...
  (setq org-structure-template-alist
        '(("s" . "src")
          ...
          ("exmd" . "export md")
          ("el" . "src emacs-lisp")
          ("sh" . "src shell :file-name: temp.sh")
          ("json" . "src json")
          ...
          ("p" . "src python :results output :file-name temp.py"))))
#+end_src
** Org clock
#+begin_src emacs-lisp
...
(use-package org-present
  ...
  :bind (:map org-present-mode-keymap
         ("C-p" . org-present-prev)
         ("C-n" . org-present-next))
