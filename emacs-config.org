...
#+end_src
** Prettify table
Download =org-pretty-table= from [[https://github.com/Fuco1/org-pretty-table][org-pretty-table]] and put it to =~/.emacs.d/lisp/=
#+begin_src emacs-lisp -n
...
| key       | description                    |
|-----------+--------------------------------|
| C-c C-x p | insert properties for headline |
