...
(use-package pangu-spacing
  ...
  ;; just display on overlay, don't add spaces when saving the file
...
(use-package org-tempo
  ...
  (setq org-structure-template-alist
        '(("s" . "src")
          ...
          ("html" . "src html")
          ("md" . "src markdown")
          ("sql" . "src sql :results raw drawer :engine mysql :database midea_cs :file-name temp.sql")
          ("exhtml" . "export html")
          ("exmd" . "export md")
          ("el" . "src emacs-lisp -n")
          ("sh" . "src shell :results output :file-name: temp.sh")
          ("bs" . "src bash :results output :file-name: temp.sh")
          ("json" . "src json")
...
** Mermaid settings
Need to install =mermaid-cli= first.
#+begin_src emacs-lisp
